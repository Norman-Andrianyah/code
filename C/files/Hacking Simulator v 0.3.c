...
int main() {
    ...
    {
        printf("pilih perangkat yang ingin anda retas\n");
        printf("(masukan nomor)\n\n");
        ...
        if (hackto2 == '1')
        {
            printf("pilih metode peretasan untuk perangkat Android\n");
            printf("(masukan nomor)\n\n");

            printf("%d merusaknya dengan virus\n", num1);
            printf("%d meretas layar kunci\n", num2);
            printf("%d mencari data pengguna\n", num3);
        }
        else if (/* condition */)
        {
            /* code */
