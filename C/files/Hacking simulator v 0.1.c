...
int main() {
    ...
    nomer7 = nomer3 + nomer4;
    nomer8 = nomer4 + nomer4;
    nomer9 = nomer5 + nomer4;
    nomer10 = nomer5 + nomer5; 
    ...
    printf("masukan URL website untuk menghacking: \n");
    gets(site);
    printf("\n");
    ...
    {
        printf("menggunakan virus GTB T4...\n");
        printf("kerusakan: besar\n");
        while (viruscreate <= 10000)
        {
    ...
    {
        printf("menggunakan virus E-bola v0.1...\n");
        printf("kerusakan: sedang\n");
        while (viruscreate <= 10000)
        {
    ...
    {
        printf("menggunakan virus polo-Maniac...\n");
        printf("kerusakan: sedikit\n");
        while (viruscreate <= 10000)
        {
    ...
    {
        printf("menggunakan virus Qoedro C3 EXPERT...\n");
        printf("kerusakan: sangat besar (beresiko menghancurkan komputer)\n");
    ...
    while (connecting1 <= 1000)
    {
        printf("menunggu jaringan %d/100\n", connecting1);
        connecting1++;
    }
    while (connecting2 <= 1000)
    {
